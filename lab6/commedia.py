...
def load_data():
    ...
    f=open('Lab_ML/lab6/data/inferno.txt', encoding="ISO-8859-1")
    ...
    f=open('Lab_ML/lab6/data/purgatorio.txt', encoding="ISO-8859-1")
    ...
    f=open('Lab_ML/lab6/data/paradiso.txt', encoding="ISO-8859-1")
...
if __name__ == '__main__':
    ...
    print('Multiclass - S2 - Accuracy:', compute_accuracy(S2_predictions, labelsEval))
    ...
    print('Binary (From multiclass) - S2 - Accuracy:', compute_accuracy(P, labelsEval))
